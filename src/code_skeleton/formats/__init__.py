...
from code_skeleton.formats.json_fmt import JsonFormatter
from code_skeleton.formats.markdown_fmt import MarkdownFormatter
from code_skeleton.formats.yaml_fmt import YamlFormatter

if TYPE_CHECKING:
    from code_skeleton.core.types import Skeleton
...
def write_schemas(output_dir: Path) -> None:
    ...
    package = files("code_skeleton.schemas")
