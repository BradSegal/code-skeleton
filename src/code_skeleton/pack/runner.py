"""Orchestrates `code-skeleton pack`."""
...
from code_skeleton.pack.compress import compress_python_file
from code_skeleton.pack.deps import PythonModuleIndex, dependency_closure, reverse_dependency_closure
from code_skeleton.pack.discovery import discover_paths
from code_skeleton.pack.formats import (
    ContentEncoding,
    PackFile,
    PackFormat,
    PackPayload,
...
from code_skeleton.pack.ignore import build_excluder
from code_skeleton.pack.jsonl import JsonlFile, iter_jsonl_file_records, iter_jsonl_prefix
from code_skeleton.pack.limit import LimitKind, OutputLimit
from code_skeleton.pack.match import GlobMatcher
from code_skeleton.pack.mode import PackMode
from code_skeleton.pack.overview import build_pack_overview
from code_skeleton.pack.representations import (
    FileRepresentation,
...
from code_skeleton.pack.summaries import SummaryConfig, python_summary, summary_for_text
from code_skeleton.pack.tokens import TokenCounts, count_content_tokens_by_path, count_tokens
from code_skeleton.pack.tree import render_structure_tree
...
def _process_one_file(
    ...
    *,
    ...
    from code_skeleton.pack.discovery import DiscoveredPath
    ...
    *,
    ...
    if entries:
        ...
        if uses:
            ...
            if positions:
                from code_skeleton.pack.pyright_lsp import pyright_referenced_files
...
def _with_part_suffix(path: Path, part: int) -> Path:
    # code-skeleton-pack.md -> code-skeleton-pack.1.md
    if path.suffix:
