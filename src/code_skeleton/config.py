"""Configuration handling for code-skeleton.
...
from code_skeleton.pack.formats import ContentEncoding, PackFormat, infer_pack_format_from_output_path
...
class PackConfig(BaseModel):
    """Configuration for `code-skeleton pack`."""
...
class SkeletonConfig(BaseModel):
    ...
    This can be loaded from a .code-skeleton.yaml file in the project root.
    ...
    pack
        Defaults for `code-skeleton pack`.
    """
    ...
    def find_config(cls, start_dir: Path | None = None) -> SkeletonConfig | None:
        ...
        Searches for .code-skeleton.yaml in the current directory and parent
        ...
        while True:
            config_path = current / ".code-skeleton.yaml"
