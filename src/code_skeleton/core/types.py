"""Pydantic models for code skeleton data structures.

This module defines the core data models used throughout the code-skeleton
...
class SkeletonMetadata(BaseModel):
    ...
    ----------
    generator_version
        Version of code-skeleton that generated this.
    sources
